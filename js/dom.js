...
const pintarCard = data => {
    data.forEach(producto => {
        if (producto.id < 16) {
            ...
            templateCard.querySelector('.btnAgregar').dataset.id = `btn-${producto.id}`
            templateCard.querySelector('.btnDetalles').dataset.id = `btn-${producto.id}-b`
            ...
            templateCard2.querySelector('.btnDetalles').dataset.id = `${producto.id}-b`
